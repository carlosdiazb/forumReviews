            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3" style="margin-top:20px;">
                            <label for="password-confirm" class="col-md-4 col-form-label text-md-end" style="font-size:20px;">{{ __('Confirm Password') }}</label>
                        ...
                        <div class="row mb-0" style="margin-top:30px;">
                            <div class="col-md-6 offset-md-4">
                                <button type="submit" class="btn" style="background-color:black; color:white; width:100px;">
                                    {{ __('REGISTER') }}
                                </button>
                            </div>
                        </div>
